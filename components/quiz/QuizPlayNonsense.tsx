...
interface QuizPlayNonsenseProps {
...
export default function QuizPlayNonsense({
  question,
  answer,
  explanation,
  onAnswer,
  ...
  return (
    <div className="space-y-6">
      {/* 문제 (제목) */}
      <div className="text-lg sm:text-xl font-semibold text-white mb-6">
        {question}
      </div>
