...
const CATEGORIES: { [key: string]: { label: string; icon: string; color: string } } = {
  notice: { label: '공지사항', icon: 'ri-megaphone-line', color: 'from-red-500 to-pink-500' },
  daily: { label: '오늘의 문제/데일리', icon: 'ri-calendar-check-line', color: 'from-yellow-500 to-orange-500' },
  recommend: { label: '문제 추천/공유', icon: 'ri-share-forward-line', color: 'from-green-500 to-emerald-500' },
  free: { label: '자유게시판', icon: 'ri-chat-3-line', color: 'from-blue-500 to-cyan-500' },
  bug: { label: '버그/개선', icon: 'ri-bug-line', color: 'from-purple-500 to-indigo-500' },
  hall_of_fame: { label: '명예의 전당', icon: 'ri-trophy-line', color: 'from-yellow-400 to-amber-500' },
  funny: { label: '웃긴 질문/드립', icon: 'ri-emotion-laugh-line', color: 'from-pink-500 to-rose-500' },
  social: { label: '친목', icon: 'ri-group-line', color: 'from-teal-500 to-cyan-500' },
};
